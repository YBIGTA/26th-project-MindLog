...
struct SignUpView: View {
    ...
    var body: some View {
        VStack {
            Spacer()
            VStack(spacing: 20) {
                CustomLabeledTextField(label: "Username", text: $username)
                CustomLabeledTextField(label: "E-mail", text: $email, autocapitalization: .none)
                CustomLabeledTextField(label: "Password", text: $password, isSecure: true, autocapitalization: .none)
            }
            .padding(.horizontal, 30)
            Spacer()
            Button(action: {
